  ...
  */
   ...
   */
    ...
    struct Particle{
      ...
      */
      Particle(const ScanMatcherMap& map, const MgMatcherMap& map_mg);
    ...
    */
    ...
    void setSensorMap_mg(const SensorMap& smap);
	...
	bool processScan_mg(const MgReading& reading, int adaptParticles=0);
  ...
  private:
	...
	inline void scanMatch_mg(const double (*plainReading)[3]);
    ...
    inline bool resample_mg(const double (*plainReading)[3], int adaptParticles, const MgReading* rr=0);
